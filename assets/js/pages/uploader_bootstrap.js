...
$(function() {
    ...
    $('.file-input').fileinput({
        ...
        uploadClass: 'btn bg-teal-400 btn-ladda btn-ladda-spinner',
    ...
    $(".file-input-extensions").fileinput({
        ...
        uploadClass: 'btn bg-teal-400 btn-xs btn-ladda btn-ladda-spinner',
        browseIcon: '<i class="icon-file-plus"></i>',
        uploadIcon: '<span class="ladda-label"><i class="icon-file-upload2"></i></span>',
        removeIcon: '<i class="icon-cross3"></i>',
        removeClass: 'btn btn-link btn-icon btn-xs cl',
        layoutTemplates: {
            icon: '<i class="icon-file-check"></i>',
            modal: modalTemplate
        },
        ...
        maxFilesNum: 10,
        maxFileSize: 5120,
        allowedFileExtensions: ["jpg", "png", "pdf", "jpeg", "doc", "docx", "doc", "xls", "xlsx", "ppt", "pptx", "mp4"],
        initialCaption: "No file selected",
        previewZoomButtonClasses: previewZoomButtonClasses,
        previewZoomButtonIcons: previewZoomButtonIcons,
        fileActionSettings: fileActionSettings
    ...
    $(".file-input-excel").fileinput({
        browseLabel: 'Pilih Excel',
        browseClass: 'btn btn-primary btn-xs',
        uploadClass: 'btn btn-default btn-xs btn-ladda btn-ladda-spinner',
        browseIcon: '<i class="icon-file-plus"></i>',
        uploadIcon: '<span class="ladda-label"><i class="icon-file-upload2"></i></span>',
        removeIcon: '<i class="icon-cross3"></i>',
        layoutTemplates: {
